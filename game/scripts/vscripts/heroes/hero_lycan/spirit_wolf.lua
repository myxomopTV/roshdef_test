...
--]]
		...
		caster.bear:SetBaseDamageMin(base_dmg + strenght*dmg_per_strenght )
		caster.bear:SetBaseDamageMax(base_dmg + strenght*dmg_per_strenght )				
		...
		SetLevelForSubAbility(ability, "lycan_summon_wolves_critical_strike", caster.bear, 1, nil)
		SetLevelForSubAbility(ability, "lycan_summon_wolves_beowolf", caster.bear, 6, 1)
		...
		if ability ~= nil then
			ability:ApplyDataDrivenModifier(caster, caster.bear, "modifier_spirit_wolf", nil)
		end
	end
